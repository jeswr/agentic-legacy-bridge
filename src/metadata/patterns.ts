 ...
 */
export const SENT_AT_PATTERN_HASH =
  "sha256:1e0271727a8bb1d3f9ccd4cd4553c36c2490b70e31cc1aac193a3a440d27e45e";

/** The pre-computed `sha256:` content-address of {@link PROPOSE_TIMES_PATTERN_TURTLE}. */
export const PROPOSE_TIMES_PATTERN_HASH =
  "sha256:34f2e9a3395d6732adab7ea62c266fa5e03025b71ab1c685f3266d22f90be489";

/** The pre-cached `(pattern IRI → sha256 content-address)` table this package ships. */
export const KNOWN_PATTERN_HASHES: ReadonlyMap<string, string> = new Map([
...
export function knownPatternHash(iri: string): string | undefined {
 ...
 */
export async function hashPatternDocument(turtle: string): Promise<string> {
 ...
 */
export async function verifyPatternDocument(
  turtle: string,
  expectedHash: string,
): Promise<boolean> {
  if (typeof turtle !== "string" || !/^sha256:[0-9a-f]{64}$/.test(expectedHash)) return false;
  try {
