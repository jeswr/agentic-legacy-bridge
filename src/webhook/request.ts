...
export const UNAUTHORIZED: WebhookResponse = Object.freeze({ status: 401 });
/** A 413 — the request body exceeds the hard cap (a pre-verification DoS guard). */
export const PAYLOAD_TOO_LARGE: WebhookResponse = Object.freeze({ status: 413 });
/** A bare 200 ack (verified + handled; nothing to echo). */
export const OK: WebhookResponse = Object.freeze({ status: 200 });
