...
import { type AgenticReplyVerifier, type PatternConformance } from "./agentic-reply.js";
/**
 ...
 */
export declare class StructuredMetadataInterpreter implements Interpreter {
...
export declare const structuredMetadataInterpreter: Interpreter;
 ...
 */
export declare function extractStructuredMetadata(message: BridgeMessage | EmailMessage, ctx: InterpretContext, options?: StructuredMetadataOptions): Promise<StructuredMetadataResult>;
/**
 ...
 */
export declare function composeInterpreters(...interpreters: readonly Interpreter[]): Interpreter;
