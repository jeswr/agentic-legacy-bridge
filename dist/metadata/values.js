...
export function asBoundedString(value, maxChars) {
 ...
 */
function exactUtcMs(y, mo, d, h, mi, s) {
...
export function parseWhen(value) {
    if (typeof value !== "string" || value.length > MAX_WHEN_CHARS)
        return undefined;
    const v = value.trim();
...
export function whenDatatype(when) {
...
export const AMBIGUOUS_TZ_NOTE = "resolved from a zone-less local time assuming UTC — verify the timezone.";
