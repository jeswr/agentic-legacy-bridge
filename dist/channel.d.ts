 ...
 */
export declare function parseEmailInbound(item: InboundRawMessage): BridgeMessage;
/**
...
export declare class InMemoryChannelAdapter implements ChannelAdapter {
    ...
    constructor(channel: string, messages: readonly InboundRawMessage[], parse?: (item: InboundRawMessage) => BridgeMessage);
    parse(item: InboundRawMessage): BridgeMessage;
    pullInbound(): Promise<readonly InboundRawMessage[]>;
    sendReply(target: ReplyTarget, reply: BuiltReply): Promise<void>;
}
